...
void myGpio_init(void)
{
    ...
    GPIO_setCallback(CONFIG_GPIO_BUTTON_0, gpioButtonFxn0);                     // When "SW2" is pressed, call 'gpioButtonFxn1'
    GPIO_setCallback(CONFIG_GPIO_BUTTON_1, gpioButtonFxn1);                     // When "SW2" is pressed, call 'gpioButtonFxn1'

    // Enable interrupts

    GPIO_enableInt(CONFIG_GPIO_BUTTON_0);  // Enable individual interrupt for Board_GPIO_BUTTON1
